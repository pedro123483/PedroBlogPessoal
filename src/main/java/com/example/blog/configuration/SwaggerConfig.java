...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.basePackage("com.example.blog.controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder()
				.title("API - Blog Pessoal Pedro")
				.description("Projeto API Spring - Blog Pessoal Pedro")
				.version("1.0.0")
	        ...
	        private static Contact contact() {
	        	return new Contact("Pedro Silva",
	        			"https://github.com/pedro123483",
	        			"pg308758@gmail.com");
	        }
